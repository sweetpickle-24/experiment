...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('discrimination_threshold_output.log'),
...
def measure_concentration_response(brain, odor_name, concentration, door_client):
    ...
    brain.inject_external_input('ORN', glom_pattern, strength=scaled_strength)
...
def main():
    ...
    # Save results
    output_file = 'discrimination_threshold_results.json'
